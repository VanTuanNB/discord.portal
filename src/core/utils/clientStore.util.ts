'use client';
import { THEME_OPTION } from '../constants/common.constant';
import { LocalStorageKey } from '../constants/store.constant';

export interface IClientStore {
    localStorage: {
        [LocalStorageKey.THEM]: THEME_OPTION.DARK | THEME_OPTION.LIGHT;
        [LocalStorageKey.DISCORD_USER_TOKEN]: string;
    };
    sessionStorage: {
        [key: string]: string;
    };
