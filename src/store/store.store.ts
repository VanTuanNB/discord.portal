...
import { BaseCoreService } from './services/base.service';
...
export const store = configureStore({
    reducer: {
        ...
        [REDUCER_SELECTOR.USER]: userSlice.reducer,
        // [ESelectReducer.CLIENT_STORE]: clientStoreSlice.reducer,
        // [ESelectReducer.SONG]: songSlice.reducer,
    },
    middleware: (getDefaultMiddleware) => getDefaultMiddleware().concat(BaseCoreService.middleware),
